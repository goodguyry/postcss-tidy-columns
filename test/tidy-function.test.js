...
describe('The `tidy-offset` functions are replaced and their values reflect the expected options', () => {
  ...
  test(
    ...
    () => run(
      ...
      'div { margin-left: calc(((((100vw - 1.25rem) / 12 - 1.1458rem) * 3) + 1.25rem * 3) + 20px); }',
      typical,
    ),
  );
  ...
  test(
    ...
    () => run(
      ...
      'div { margin-left: calc(20px + ((((100vw - 1.25rem) / 12 - 1.1458rem) * 3) + 1.25rem * 3)); }',
      typical,
    ),
  );
  ...
  test(
    ...
    () => run(
      ...
      'div { margin: 0 calc((((100vw - 1.25rem) / 12 - 1.1458rem) * 3) + 1.25rem * 3) 0 calc(((100vw - 1.25rem) / 12 - 1.1458rem) + 1.25rem); }',
      typical,
    ),
  );
  ...
  test(
    ...
    () => run(
      'div { margin-left: tidy-offset(1); }',
      'div { /* margin-left: tidy-offset(1) */ margin-left: calc(((100vw - 1.25rem) / 12 - 1.1458rem) + 1.25rem); }',
      { ...typical, debug: true },
    ),
  );
  ...
  test(
    ...
    () => run(
      'div { margin-left: tidy-offset-full(1); }',
      'div { /* margin-left: tidy-offset-full(1) */ margin-left: calc(((90rem - 1.25rem) / 12 - 1.1458rem) + 1.25rem); }',
      { ...typical, debug: true },
    ),
  );
  ...
  test(
    ...
    () => run(
      ...
      'div { /* margin: tidy-offset(1) 0 0 tidy-var(gap) */ margin: calc(((100vw - 1.25rem) / 12 - 1.1458rem) + 1.25rem) 0 0 1.25rem; }',
      { ...typical, debug: true },
    ),
  );
});
...
describe('The `tidy-span()` functions are replaced and their values reflect the expected options', () => {
  test(
    ...
    () => run(
      ...
      'div { width: calc((100vw - 1.25rem) / 12 - 1.1458rem); }',
      typical,
    ),
  );
  ...
  test(
    ...
    () => run(
      ...
      'div { max-width: calc((90rem - 1.25rem) / 12 - 1.1458rem); }',
      typical,
    ),
  );
});
