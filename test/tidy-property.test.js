...
describe('The `tidy-offset-*` properties are replaced and their values reflect the expected options', () => {
  ...
  test(
    ...
    () => run(
      ...
      'div { margin-right: calc((((min(100vw, 90rem) - 0.625rem * 2) / 12 - 1.1458rem) * 2) + 1.25rem * 2); }',
      typical,
    ),
  );
...
describe('The `tidy-span` property is replaced and its values reflect the expected options', () => {
  test(
    ...
    () => run(
      'div { tidy-span: 2; }',
      'div { width: calc((((min(100vw, 90rem) - 0.625rem * 2) / 12 - 1.1458rem) * 2) + 1.25rem); }',
      typical,
    ),
  );
  ...
  test(
    ...
    () => run(
      ...
      'div { margin-left: calc(((((min(100vw, 75rem) - 32px * 2) / 16 - 0.5859rem) * 10) + 0.625rem * 10) + 32px); width: calc((((min(100vw, 75rem) - 32px * 2) / 16 - 0.5859rem) * 2) + 0.625rem); }',
      allValues,
    ),
  );
